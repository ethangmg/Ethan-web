...
export default function Skills() {
  return (
    <div className='h-screen dark:bg-gradient-reverse-blackCherry bg-gradient-light-rose-reverse  flex flex-col items-center text-white sm:w-full md:w-full sm:h-full'>
      ...
      <div className=' w-screen px-2 text-sm sm:w-full'>
        <ul className='h-48 flex flex-wrap sm:h-48'>
          ...
          <li className='mx-2'>-Redux Toolkit </li>
          <li className='mx-2'>-Typescript </li>
          <li className='mx-2'>-React Hooks </li>
          <li className='mx-2'>-react-router </li>
          <li className='mx-2'>-react-hook-form </li>
          <li className='mx-2'>-Formik </li>
